...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tipo_documentos_licitaciones', function (Blueprint $table) {
            $table->increments('id');
            $table->string('documento_licitacion')->nullable();
    ...
    {
        Schema::dropIfExists('tipo_documentos_licitaciones');
    }
};
