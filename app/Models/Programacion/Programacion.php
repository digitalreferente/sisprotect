...
class Programacion extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['cliente_id', 'tarifario_id', 'custodio_id', 'programacion_estatus_id', 'siaf_status', 'folio', 'tipo_servicio', 'fecha_servicio', 'acompanantes', 'dom_origen', 'dom_destino', 'observaciones', 'created_at', 'updated_at', 'iduserCreated', 'iduserUpdated'];
