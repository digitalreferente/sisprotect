...
class StatusUnidad extends Model
{
     ...
     * @var string
     */
    protected $table = 'status_unidad';

    /**
     * @var array
     */
    protected $fillable = ['id_status_delete', 'nombre_status', 'iduserCreated', 'iduserUpdated', 'created_at', 'updated_at'];
    ...
    {
        return $this->hasMany('App\Models\Unidad\Unidad', 'id_status');
    }
}
