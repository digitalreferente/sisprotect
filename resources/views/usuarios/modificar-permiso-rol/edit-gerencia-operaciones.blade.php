                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                        <label>
                          <input type="checkbox"name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='unidad_check all_unidades'  value="{{ $value->id }}" />
                          <span></span>
                        </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                        <label>
                          <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='marca_check all_unidades'  value="{{ $value->id }}" />
                          <span></span>
                        </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                        <label>
                          <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='modelo_check all_unidades'  value="{{ $value->id }}" />
                          <span></span>
                        </label>
                      </span>
                    </div>
...
{{--       <div class="col-md-4">
        <ul class="nav nav-tabs nav-tabs-line">
          <li class="nav-item">
            <a class="nav-link ubicacion_tab" data-toggle="tab" href="#kt_tab_pane_6">Ubicaciones</a>
          </li>
        </ul>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                        <label>
                          <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='ubicacion_check all_unidades'  value="{{ $value->id }}" />
                          <span></span>
                        </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                      <label>
                      <input type="checkbox" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} name="permission[]" class='tipovehiculo_check all_unidades' value="{{ $value->id }}"> 
                      <span></span>
                      </label>
                      </span>
                    </div>
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <span class="switch switch-icon">
                          <label>
                            <input type="checkbox" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} name="permission[]"  class='estatus_check all_unidades'  value="{{ $value->id }}" />
                            <span></span>
                          </label>
                        </span>
                      </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                        <label>
                          <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='aseguradora_check all_unidades'  value="{{ $value->id }}" />
                          <span></span>
                        </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                      <label>
                      <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='agencia_check all_unidades' value="{{ $value->id }}"> 
                      <span></span>
                      </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                      <label>
                      <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='documento_check all_unidades' value="{{ $value->id }}"> 
                      <span></span>
                      </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                      <label>
                      <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='asignacion_check all_unidades' value="{{ $value->id }}"> 
                      <span></span>
                      </label>
                      </span>
                    </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <span class="switch switch-icon">
                      <label>
                      <input type="checkbox" name="permission[]" {{(in_array($value->id , $permiso_roles_id)) ? 'checked' : ''}} class='mantenimiento_check all_unidades' value="{{ $value->id }}"> 
                      <span></span>
                      </label>
                      </span>
                    </div>
