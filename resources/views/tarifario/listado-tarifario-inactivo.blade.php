...
@section('content')
                    ...
                    <div class="card card-custom">
                      ...
                      <span class="card-icon">
                        <i class="flaticon2-file text-primary"></i>
                                ...
                                <h3 class="card-label">Inventario de tarifas inactivas</h3>
                            </div>
  ...
  <form method="post" id="tarifario_act_form" action="{{ route('tarifario.activartarifario') }}" enctype="multipart/form-data">
    @csrf
