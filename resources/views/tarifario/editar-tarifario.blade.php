                            ...
                            <div class="col-lg-8">
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control" id="cliente_id" name="cliente_id"  required >
                                            ...
                                            @foreach($data as $cli)
                                                <option value="{{ $cli->id }}" {{($cli->id == $tarifario->cliente_id) ? 'selected' : ''}}>{{ $cli->nombre_cliente }} / {{ $cli->razon_social }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="origen" id="origen" value="{{ $tarifario->origen }}" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Destino</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="destino" id="destino" value="{{ $tarifario->destino }}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <label># KMS</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="kms" id="kms" value="{{ $tarifario->kms }}" required/>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="ppkm_sis" id="ppkm_sis" value="{{ $tarifario->ppkm_sis }}" required/>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="ppkm_cust" id="ppkm_cust" value="{{ $tarifario->ppkm_cust }}" required/>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Caseta</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="caseta" id="caseta" value="{{ $tarifario->caseta }}" required/> 
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control" name="observaciones" placeholder="*Opcional" id="observaciones" rows="12">{{ $tarifario->observaciones }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
