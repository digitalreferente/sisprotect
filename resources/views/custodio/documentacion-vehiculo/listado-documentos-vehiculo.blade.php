...
@section('title')
    Catálogo de documentación vehiculo
@endsection
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <div class="card-title">
                              ...
                              <h3 class="card-label">Inventario de documentación del vehículo</h3>
                            </div>
                            <div class="card-toolbar">
                                ...
                                <a href="{{ route('docvehiculo.catalogodocvehiculoinactivos') }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
