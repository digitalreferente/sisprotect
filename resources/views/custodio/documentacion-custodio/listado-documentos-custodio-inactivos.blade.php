...
@section('title')
    Catálogo de documentación custodios inactivos
@endsection
...
@section('content')
                    ...
                    <div class="card card-custom">
                      ...
                      <span class="card-icon">
                        <i class="flaticon2-file text-primary"></i>
                                ...
                                <h3 class="card-label">Inventario de documentación del custodio inactivos</h3>
                            </div>
                            <div class="card-toolbar">

                                <!--begin::Button-->
                                <a href="{{ route('doccustodio.listadodoccustodio') }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
                                  Regresar</a>
                                <!--end::Button-->
  ...
  <form method="post" id="documento_act_form" action="{{ route('doccustodio.activardocumento') }}" enctype="multipart/form-data">
    @csrf
